...
LABEL_OF_WEB = Label(win, textvariable=var, bd=8, bg="yellow", font=("Helvetica", 35)).grid(row=0,column=0)

URL=StringVar()
E1 = Entry(win,bd=5,font=7,textvariable=URL).grid(row=1,column=0,ipadx=100)
button = Button(win,text="Scrape It!",bd=5,command=scrappin).grid(row=7,column=0,padx=8,pady=4)
